<template>
    <div>
        ...
        <el-card class="taskState">
            ...
            <el-divider />
            <div class="topCard">
                <span style="overflow: hidden;">任务接受情况：{{taskInfo.peopleSituation}}人</span>
                <el-divider direction="vertical" />
                <span style="overflow: hidden;">报告提交情况：{{taskInfo.finishedPeople+"/"+taskInfo.num}}人</span>
                <el-divider direction="vertical"/>
                <span style="overflow: hidden;">悬赏总金额：{{taskInfo.costSum}}元</span>
