  ...
  <el-card class="submitTask"  v-loading="loading">
    ...
    <el-form ref="formRef" :model="form" label-width="120px" :rules="rules">
      ...
      <el-form-item label="悬赏总金额(￥)"  prop="costSum">
        ...
        <span style="margin-left:1em; font-size: x-small;color: gray;">您当前的余额(￥)为：<span style="color:coral ;">{{balance}}</span></span>
        <span style="margin-left:1em; font-size: x-small;color: gray;">余额不足请及时到“个人页面”进行充值</span>
      </el-form-item>
