            ...
            <el-card>
                ...
                >
                    ...
                    <el-form-item label="留言/评论">
                        <el-input v-model="evaluationForm.comment" type="textarea" placeholder="可选"></el-input>
                    </el-form-item>
                </el-form>
            </el-card>
...
const submitAssession=()=>{
    assessReport(ReportTable.table[idx.value].reportId, sum.value, evaluationForm.comment).then((res)=>{
        if(res==='success'){
            ElMessage.success("成功提交！")
            dialogForEvaluateReport.value=false
            reflesh()
            evaluationForm.item1=0
            evaluationForm.item2=0
            evaluationForm.item3=0
            evaluationForm.item4=0
            evaluationForm.item5=0
            evaluationForm.item6=0
            evaluationForm.item7=0
        }else{
