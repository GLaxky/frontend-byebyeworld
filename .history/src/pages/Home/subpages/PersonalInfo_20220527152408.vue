<template>
  <div>
        ...
        <el-main>
          ...
          >
            ...
            <div v-if="userIsWorker==2">
              ...
              <el-descriptions-item>
                <div v-if="userIsWorker==2">
                  <el-button type="warning" round @click="">账户充值</el-button>
                ...
                <div v-else>
                  <el-button type="warning" round @click="">账户提现</el-button>
          ...
          >
            <el-form-item label="常用测试设备:" prop="device" required>
              <el-checkbox-group v-model="Infos.device">
                ...
                <!-- <el-checkbox label="Offline activities" name="device" />
                <el-checkbox label="Simple brand exposure" name="device" /> -->
              </el-checkbox-group>
            </el-form-item>
            ...
            <el-form-item label="测试方式偏好:" prop="method" required>
              <el-checkbox-group v-model="Infos.method">
                ...
                <!-- <el-checkbox label="Offline activities" name="method" />
                <el-checkbox label="Simple brand exposure" name="method" /> -->
              </el-checkbox-group>
            </el-form-item>
          </el-form>
        </el-card>
    ...
    <el-dialog v-model="dialogForCharge">
