<template>
    <div>
        <el-card v-bind="$attrs" style="">
                ...
                <span class="text">{{reportTarget.workerName}}</span>
                ...
                <span class="text">{{reportTarget.bugDescription}}</span>
                <el-divider content-position="left">缺陷复现步骤</el-divider>
                <span class="text">{{reportTarget.revealSteps}}</span>
                <el-divider content-position="left">测试设备信息</el-divider>
                <span class="text">{{reportTarget.devices}}</span>
        </el-card>
