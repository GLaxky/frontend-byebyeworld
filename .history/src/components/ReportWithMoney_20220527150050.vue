<template>
    <div>
            ...
            <div style="padding: 10px">
                ...
                <div class="bottom">
                    <template v-if="reportInfo.haveSubmittedReport">
                        ...
                        <template v-if="reportInfo.score===-1">
                            <el-button type="warning" plain round size="small" @click.stop="dialogForAccess=true">写评价</el-button>
                        </template>
        ...
        <el-dialog v-model="dialogForDetail">
            ...
            <template v-else>
                <report-info-card :report-info="reportInfo" card-title="报告详情" v-if="reportInfo">
                </report-info-card>
            </template>
        </el-dialog>
...
export default defineComponent({
    ...
    setup(props, ctx){
        ...
        const submitAssession=()=>{
            assessReport(props.reportInfo.reportId, evaluateScore.value).then((res)=>{
                if(res==='success'){
